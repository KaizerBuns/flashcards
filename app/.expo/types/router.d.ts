...
declare module "expo-router" {
  ...
  // prettier-ignore
  type StaticRoutes = `/` | `/(modals)/set/create` | `/set/create` | `/(tabs)/_layout` | `/_layout` | `/(tabs)/profile` | `/profile` | `/(tabs)/search` | `/search` | `/(tabs)/sets` | `/sets`;
  // prettier-ignore
  type DynamicRoutes<T extends string> = `/(learn)/${SingleRoutePart<T>}` | `/${SingleRoutePart<T>}` | `/(modals)/(cards)/${SingleRoutePart<T>}` | `/(modals)/set/${SingleRoutePart<T>}` | `/set/${SingleRoutePart<T>}`;
  // prettier-ignore
  type DynamicRouteTemplate = `/(learn)/[id]` | `/(modals)/(cards)/[id]` | `/(modals)/set/[id]`;
